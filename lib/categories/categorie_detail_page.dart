...
class _CategorieDetailPageState extends State<CategorieDetailPage> {
 ...
 Padding(
              ...
              child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.only(topLeft: Radius.circular(25),topRight: Radius.circular(25))),
                child: Column(
                  children: [
                    Text(widget.user1.tittle ?? '',style: AppTextStyles.headingTextStyle,),
                    Text(widget.user1.subtittle ?? '',style: AppTextStyles.headingTextStyle4,),
                    Row(mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Icon(Icons.star, color: Colors.amber),
                        Text(widget.user1.rating ?? ''),
                       Text("(${widget.user1.ratinguser ?? ''} Reviews)",style: AppTextStyles.headingTextStyle2,),
                      ],
                    ),
      ...
      bottomNavigationBar: BottomAppBar(
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Column(children: [Text("Consultation Fee"), Text("\$${widget.user1.price}")]),
            SizedBox(
              width: Get.width * 0.5,
