...
class CategoriesBooingPage extends StatefulWidget {
  ...
  @override
  State<CategoriesBooingPage> createState() => _CategoriesBooingPageState();
}

class _CategoriesBooingPageState extends State<CategoriesBooingPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: [SizedBox(height: Get.height*0.1,),
