...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar( title: Column(crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
                        "Profile & Settings",
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Account", style: AppTextStyles.headingTextStyle4),
              ...
              Text("Support", style: AppTextStyles.headingTextStyle4),
